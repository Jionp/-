	 ...
	 <div class="sap_tabs">	
			...
			<div class="resp-tabs-container">
					...
					<div class="facts">
							<!--login1-->
						<div class="register">
							<form method="post" action="././Travelchange?jsp=travelchanged" enctype="multipart/form-data">
								<p>项目编号</p>
								<input type="text" class="text" value="${travel.goodsid }" name="goodsid" readonly="readonly" >
								<p>项目名称</p>
								<input type="text" class="text" value="${travel.name}" name="name" >
								<p>项目地址</p>
								<input type="text"  value="${travel.address}" name="address" />
								<p>项目价格</p>
								<input type="text" class="text" value="${travel.price}" name="price"/>
								<p>购买数量 </p>
								<input type="text" class="text" value="${travel.buynumber}" name="buynumber" />
								<p>项目头像</p>
								<input type="file" class="text" value="${travel.bigphoto}" name="upload" >
								<input type="text" class="text" value="${travel.bigphoto}" name="photo" style="display:none">

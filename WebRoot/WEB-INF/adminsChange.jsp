	 ...
	 <div class="sap_tabs">	
			...
			<div class="resp-tabs-container">
					...
					<div class="facts">
							<!--login1-->
						<div class="register">
							<form method="post" action="./adminChange?jsp=adminchange">
								<p>用户名</p>
								<input type="text" class="text" value="${admin.username}" name="username" readonly="readonly" >
								<p>性 &nbsp;别</p>
								<input type="text" class="text" value="${admin.sex}" name="sex" >
								<p>年&nbsp;龄</p>
								<input type="text" class="text" value="${admin.age}" name="age" >
								<p>电&nbsp;话</p>
								<input type="text" class="text" value="${admin.phone}" name="phone" />
								<p>密&nbsp;码</p>
								<input type="text" class="text" value="${admin.password}" name="password"/>
								<p>权&nbsp;限 </p>
								<input type="text" class="text" value="${admin.power}" name="power" />
								<div class="sign-up">

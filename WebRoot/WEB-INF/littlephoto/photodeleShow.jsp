...
<body>
	<table class="tab" border="1" cellspacing="0">
		...
		<s:iterator value="littlephotos" id="littlephotos">  
			   <tr>
			      <td>  
			         <a style="color: red" href="././LittlephotoShow?photospeak=<s:property value="#littlephotos.photospeak"/>&photoaddress=<s:property value="#littlephotos.photoaddress"/>&goodsid=<s:property value="#littlephotos.goodsid"/> &oid=<s:property value="#littlephotos.oid"/>&jsp=littlephotoDele">

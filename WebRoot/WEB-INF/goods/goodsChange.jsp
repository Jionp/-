	 ...
	 <div class="sap_tabs">	
			...
			<div class="resp-tabs-container">
					...
					<div class="facts">
							<!--login1-->
						<div class="register">
							<form method="post" action="././goods?jsp=goodschanged">
								<p>订单号</p>
								<input type="text" class="text" value="${good.oid }" name="oid" readonly="readonly" >
								<p>用户名</p>
								<input type="text" class="text" value="${good.username}" name="username" readonly="readonly">
								<p>产品编号</p>
								<input type="text"  value="${good.goodsid}" name="goodsid" />
								<p>订单时间 </p>
								<input type="text" class="text" value="${good.intime}" name="intime"/>
								<p>出行时间</p>
								<input type="text" class="text" value="${good.gotime}" name="gotime" />
								<p>出行真实姓名</p>
								<input type="text" class="text" value="${good.name}" name="name" />
								<p>出行身份证</p>
								<input type="text" class="text" value="${good.cardid}" name="cardid" />	
